...
public class LazyBumTenFoldCVDecisionTreePredictionOnTargetTableMain {
    ...
    public static boolean useFoldsOnFile = false;

//    public static String rootDir = "output" +
//            File.separator + CurrentDate.getCurrentDateAsString() + "_10fcv_covertype";
...
//        dataSetNameToPropertiesPathsMap.put("webkb", "data/webkb/config.properties");
        ...
        dataSetNameToPropertiesPathsMap.put("mushroom", "data/covertype/config.properties");
...
//        dataSetNameToPropertiesPathsMap.put("imdb_movielens", "data/imdb_movielens/config.properties");
        ...
        for (String dataSetName : dataSetNameToPropertiesPathsMap.keySet()) {
            ...
            RunInfo runInfo = runTest(dataSetName, propertiesPath);
...
//        String[] dataSetNames = new String[dataSetNameToPropertiesPathsMap.keySet().size()];
        ...
        String overviewCSVFileName = getRootDir() + File.separator + "overview_datasets_10fCV_lazubumdts.csv";
    ...
    public static RunInfo runTest(String dataSetName, String propertiesPathStr) throws IOException, ClassNotFoundException {
...
//            LazyBumTreeBuilder treeBuilder = setupResultWrapper.treeBuilder;
            ...
            String outputDirStr = getRootDir() + File.separator +
...
//            outputFileWriter.newLine();
        ...
        return new FoldInfo(accuracy, totalTimeForFold, totalTimeForLearning, totalTimeForPrediction, nbOfNodesInTree);
    }
